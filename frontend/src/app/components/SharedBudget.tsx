...
export function SharedBudget() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        <h2 className="mb-2">Совместный бюджет</h2>
        <p className="text-muted-foreground">
          Управляйте финансами вместе с соседями или партнёром
        </p>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-border p-6">
        ...
        <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <p className="text-sm text-blue-900">
            💡 Люди с этой ссылкой смогут просматривать и добавлять транзакции в общий бюджет
          </p>
        </div>
      </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3 p-3 bg-muted rounded-lg">
            ...
            <div className="flex-1">
              <p style={{ fontWeight: '600' }}>Александр (Вы)</p>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-border p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3>Telegram-бот</h3>
            <p className="text-sm text-muted-foreground">
              Быстро добавляйте расходы через Telegram
            </p>
          </div>
        </div>
        ...
        {!botConnected ? (
          <div className="space-y-4">
            <div>
              <p className="text-sm text-muted-foreground mb-3">
                Отправьте боту @MyFinancesBot команду <code className="bg-muted px-2 py-1 rounded">/start</code>,
                затем введите ваш Telegram username
              </p>
            ...
            <div className="bg-muted rounded-lg p-4">
              <p className="text-sm mb-2" style={{ fontWeight: '600' }}>Примеры команд:</p>
              <ul className="text-sm text-muted-foreground space-y-1">
                <li><code className="bg-white px-2 py-0.5 rounded">кофе 200</code> — добавить расход</li>
                <li><code className="bg-white px-2 py-0.5 rounded">еда 500 обед</code> — с комментарием</li>
                <li><code className="bg-white px-2 py-0.5 rounded">доход 35000 стипендия</code> — доход</li>
              </ul>
            </div>
          </div>
        ) : (
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 flex items-start gap-3">
            ...
            <div>
              <p className="text-emerald-900" style={{ fontWeight: '600' }}>
                Telegram-бот подключен!
              </p>
              <p className="text-sm text-emerald-700">
                Теперь можно добавлять транзакции через @MyFinancesBot
              </p>
            </div>
          </div>
        )}
